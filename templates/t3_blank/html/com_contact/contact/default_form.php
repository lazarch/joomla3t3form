...
<!--  COM_CONTACT_SURNAME="Фамилия"      -->
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('contact_surname'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('contact_surname'); ?></div>
			</div>			
<!--  COM_CONTACT_MRMRS="МужЖен"       -->
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('contact_mrmrs'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('contact_mrmrs'); ?></div>
			</div>
<!--  COM_CONTACT_COMPANY="Компания"       -->
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('contact_company'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('contact_company'); ?></div>
			</div>						
 <!--  COM_CONTACT_ADDRESS="Адрес"      Street Address -->
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('contact_address'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('contact_address'); ?></div>
			</div>	
 <!--  COM_CONTACT_POSTCODE="Почтовый код" -->
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('contact_postcode'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('contact_postcode'); ?></div>
			</div>	
 <!-- COM_CONTACT_SUBURB="Город" -->
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('contact_suburb'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('contact_suburb'); ?></div>
			</div>
 ...
 <!-- COM_CONTACT_COUNTRY="Страна" -->
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('contact_contry'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('contact_contry'); ?></div>
			</div>
 <!--  COM_CONTACT_TELEPHONE="Телефон" -->			
			<div class="control-group"> 
				<div class="control-label"><?php echo $this->form->getLabel('contact_telephone'); ?></div>
